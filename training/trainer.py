...
class Trainer(AbstractTrainer):
    ...
    def train_iteration(self):
        ...
        #         self.visualizer.show_pointclouds(points=self.network.templates[0].vertex, title=f"template0")
        #     if self.opt.patch_deformation and self.opt.dim_out_patch == 3:
        #         template = self.network.templates[0].vertex
